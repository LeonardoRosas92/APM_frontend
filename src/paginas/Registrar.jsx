...
const Registrar = () => {
    ...
    const handleSubmit = async e => {
        ...
        if (password !== repetirPassword) {
            setAlerta({
                msg: 'Los password no son iguales', error: true
            });
            return;
        }
        ...
        try {
            ...
            await clienteAxios.post(
                url,{nombre, email, password}
            );
            setAlerta({
                msg: 'Creado correctamente, revisa tu correo para confirmacion',
                error: false
            });
        } catch (error) {
            ...
            <div className="mt-20 md:mt-5 shadow-lg px-5 rounded-xl py-1 bg-white">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="my-5">
                        ...
                        <input type="text" placeholder="Tu Email" className="border w-full p-3 mt-3 bg-gray-50 rounded-xl"
                            value={email}
